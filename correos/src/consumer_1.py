...
def run():
    ...
    channel.queue_bind(exchange=EXCHANGE_NAME, queue=queue, routing_key=binding_key_1)
    channel.queue_bind(exchange=EXCHANGE_NAME, queue=queue, routing_key=binding_key_2)
